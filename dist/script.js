        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              i === 0 ? state[prop] = "Холодное" : state[prop] = "Тёплое"; //пройтись по всем чекбоксам и убрать галочки со всех, кроме тех, на которые кликнул пользователь
...
/* harmony default export */ __webpack_exports__["default"] = (changeModalState); //сбор данных, введенных пользователем в форме-калькуляторе
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(item); //если форма содержит дополнительные данные (обозначается атрибутом в HTML), то их надо поместить в formData
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        windows = document.querySelectorAll('[data-modal]'); //открытие модальных окон для разных триггеров через перебор массива
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        modal.style.display = "block"; //запрет прокрутки при открытом модальном окне. класс из bootstrap
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    var target = e.target; //из tabSelector(это придет класс) с помощью рег.выр. убираем точку из начала (заменяем на пустую строку)
...
/* harmony default export */ __webpack_exports__["default"] = (tabs); //делегирование событий: вешаем обработчик события на общий блок (header),
